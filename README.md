...
To run the bot on your server, follow the instructions on this [discord.js guide page](https://discordjs.guide/legacy/preparations/app-setup) to create your bot token and invite link and add the bot to your server. Be sure to have `discord.js` installed.
